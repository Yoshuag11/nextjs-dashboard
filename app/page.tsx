...
const { "font-test": fontTest, shape } = homeStyles;
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6 dark:bg-gray-950">
      <div className="flex h-20 shrink-0 items-end rounded-lg bg-blue-500 p-4 md:h-52">
        <AcmeLogo />
      </div>
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div
          className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 dark:bg-gray-600 \
...
border-l-transparent border-r-transparent border-b-black"
          />
          <p
            className={`${lusitana.className} ${fontTest} text-xl text-gray-800 dark:text-gray-200 \
